...
const TABCONTENT_TEMPLATE = [
	[
		"core/button",
		{
			tagName: "button",
			className: "tab-button",
			placeholder: __("Enter tab label", "celorgscratch"),
		},
	],
	[
		"core/group",
...
// Register Block
registerBlockType("celorgscratch/tabblock", {
	...
	edit: (props) => {
		...
		return (
			<div {...blockProps} className="single-tab-wrap" role="tablist">
				<InnerBlocks template={TABCONTENT_TEMPLATE} allowedBlocks={["core/button", "core/group"]} />
			</div>
		);
	},
	save: (props) => {
