...
function my_custom_block_register_block() {
     ...
     register_block_type('celorgscratch/posts-display', array(
          'editor_script' => 'celorgscratch-editor',
